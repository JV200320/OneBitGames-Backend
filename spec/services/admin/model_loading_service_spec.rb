  ...
  context "when #call" do
    ...
    context "when params are present" do
      let!(:search_system_requirements) do
        system_requirements = []
        15.times do |n|
          system_requirements << create(:system_requirement, name: "Search #{n + 1}", video_board: "AMD")
        end
        system_requirements
      end
      ...
      let(:params) do
        { search: { name: "Search", video_board: 'AMD' }, order: { name: :desc }, page: 2, length: 4 }
      end
      ...
      it "doesn't return unexpected records" do
