module Admin::V1
  class ProductsController < ApiController
    ...
    def destroy
      ...
      render_error(fields: @product.errors.messages.merge(@product.productable.errors.message))
    end
    ...
    def product_params
      ...
      permitted_params = params.require(:product).permit(:id, :name, :description, :image, :featured,
